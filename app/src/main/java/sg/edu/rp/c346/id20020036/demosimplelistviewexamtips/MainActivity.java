package sg.edu.rp.c346.id20020036.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTipsArray[1] = "Seek help from the lecturer ASAP, don't wait till you are lost in the jungle.";
        examTipsArray[2] = "Prepare your template code for each topic.";
        examTipsArray[3] = "Create a few Android projects to speed up you coding during the exam.";
